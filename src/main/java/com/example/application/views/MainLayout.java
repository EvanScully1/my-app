...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Feed", LineAwesomeIcon.BUFFER.create(), FeedView.class), //

                new MenuItemInfo("Trending", LineAwesomeIcon.CHART_LINE_SOLID.create(), TrendingView.class), //

                new MenuItemInfo("Profile", LineAwesomeIcon.USER.create(), ProfileView.class), //

                new MenuItemInfo("User Database", LineAwesomeIcon.USERS_SOLID.create(), UserDatabaseView.class), //
